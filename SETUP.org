...
about included modules [[https://www.gnu.org/software/guile/docs/docs-2.0/guile-ref/Included-Guile-Modules.html][
here]].

If you need help getting set up, see [[http://help.exercism.io/getting-started-with-scheme.html][
